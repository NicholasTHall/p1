            ...
            modelBuilder.Entity("PizzaWorld.Domain.Abstracts.APizzaModel", b =>
                {
                    ...
                    b.Property<long?>("PizzaCrustEntityId")
                        .HasColumnType("bigint");

                    b.Property<long?>("PizzaSizeEntityId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("PizzaCrustEntityId");

                    b.HasIndex("PizzaSizeEntityId");
            ...
            modelBuilder.Entity("PizzaWorld.Domain.Abstracts.APizzaModel", b =>
                {
                    ...
                    b.HasOne("PizzaWorld.Domain.Models.PizzaComponents.PizzaCrust", "PizzaCrust")
                        .WithMany()
                        .HasForeignKey("PizzaCrustEntityId");

                    b.HasOne("PizzaWorld.Domain.Models.PizzaComponents.PizzaSize", "PizzaSize")
                        .WithMany()
                        .HasForeignKey("PizzaSizeEntityId");
